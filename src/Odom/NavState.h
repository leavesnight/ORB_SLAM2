...
public:
  Sophus::SO3 mRwb;	// rotation Rwbj=Rwb(tj)=qwbj=wqwb(tj)=Phiwbj=wPhiwb(tj), public for g2otypes
  ...
  void setRwb(const Matrix3d &Rwb){mRwb=Sophus::SO3(Rwb);}//implicitly use SO3(Matrix3d)
