...
python ./evaluate_ate.py ~/dataset/EuRoC/$EUROCFILE/groundtruth.txt ~/dataset/EuRoC/$EUROCFILE/orbslam2/$SUBFILE/KeyFrameTrajectoryIMU.txt --verbose --offset $OFFSET --plot PLOT >result_ate.txt 
python ./evaluate_ate.py ~/dataset/EuRoC/$EUROCFILE/groundtruth.txt ~/dataset/EuRoC/$EUROCFILE/orbslam2/$SUBFILE/KeyFrameTrajectoryIMU_NO_FULLBA.txt --verbose --offset $OFFSET --plot PLOT_N >result_ate_NO.txt 
...
python ./evaluate_ate_scale.py ~/dataset/EuRoC/$EUROCFILE/groundtruth_estimate0.txt ~/dataset/EuRoC/$EUROCFILE/orbslam2/$SUBFILE/KeyFrameTrajectoryIMU.txt --verbose --offset 0. --plot PLOT_GTest >result_ate_GTest.txt 
python ./evaluate_ate_scale.py ~/dataset/EuRoC/$EUROCFILE/groundtruth.txt ~/dataset/EuRoC/$EUROCFILE/orbslam2/$SUBFILE/KeyFrameTrajectoryIMU.txt --verbose --offset $OFFSET --plot PLOT_GT >result_ate_GT.txt 
