...
int main(int argc, char **argv){
	...
	switch (argc){
	  ...
	  case 6:
	    ...
	    break;
	  default:
	    cerr << redSTR"Usage: rosrun ORB_SLAM2 RGBDpub path_to_vocabulary path_to_settings path_to_sequence path_to_association path_to_odometryData"
	...
	ORB_SLAM2::System SLAM(argv[1],argv[2],sensor,show_viewer);
	bool bLoaded=false;
